...
public class PopupStartLevel : BaseBox
{
    ...
    public void GetHeart(bool success)
    {
        if (success)
        {
            SuccessAddHeart();
            ...
            GameAnalytics.LogGetItem("Heart", 1, "ads", 1, 1, sceneName, popupName);
        }
        else
        {
    ...
    public void AddHeart()
    {
        ...
        if (GameData.Heart <= 0)
        {
            btnAddHeart.GetComponent<ShowRewardedController>().Show();
            return;
        }
        if (GameData.newTut)
        {
    ...
    public void GetBullet(bool success)
    {
        if (success)
        {
            ...
            GameAnalytics.LogGetItem("Bullet", 3, "ads", 1, 1, sceneName, popupName);
            GameAnalytics.LogUseItem("Bullet", 3, "ads", sceneName, popupName);
        }
        else
        {
    ...
    public void AddBullet()
    {
        ...
        if (GameData.Bullets <= 0)
        {
            btnAddBullet.GetComponent<ShowRewardedController>().Show();
            return;
        }
        if (GameData.newTut)
        {
    ...
    public void StartLevel()
    {
        ...
        {
            GameData.Heart--;
            GameAnalytics.LogUseItem("Heart", 1, "ads", sceneName, popupName);
            GameAnalytics.LogGetItem("Health", 1, "ads", 1, 1, "GamePlay", "gameplay");
            GameAnalytics.LogUseItem("Health", 1, "ads", "GamePlay", "gameplay");
        }
