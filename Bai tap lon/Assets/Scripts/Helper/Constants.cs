...
public class Constants
{
    ...
    public static class Audio
    {
        ...
        public const string MUSIC_SEA = "BgWater";
        public const string MUSIC_UNDER_BONUS = "star_bonus";
        public const string MUSIC_DESERT = "BgDesert";
        public const string MUSIC_ICE = "BgIce";
        public const string MUSIC_HALLOWEEN = "BgHalloween";
        ...
        //public const string CHEST_SMAL_OPEN = "Chest_smal_open";
        //public const string LEVER_SPIN = "lever_spin";
        //public const string CLAIM_TEM = "item_rare";
        //public const string POPUP_GIFT = "Wheel_sector_win";
        //public const string SPIN_JACKPOT = "Wheel_start";
        //public const string POPUP_WIN = "win_final_popup";
        //public const string CAR_HORN = "car_horn";
        //public const string CAR_MOVE = "car_move";
        //public const string PLAY_LAND = "player_land1";
        //public const string LASER_SHOOT = "laser_on";
        //public const string COLLECT_ITEM = "Collect_item";
        //public const string CATCH_PLAYER = "come_out";
        //public const string POLICE_CAR = "PoliceSirenVariou";
    }
    ...
    public static class PathPrefabs
    {
        ...
        public const string POPUP_SETTINGS = "Box/PopupSettings";
        ...
        public const string POPUP_HALLOWEEN = "Box/PopupHalloween";
    }
    public static class LAYER
    {
        public static int BORDER = 19;
        public static int ONLY_GROUND = 11;
        public static int DEFAULT = 0;
        public static int GROUND = 6;
        public static int PLAYER = 9;
        public static int RAG_DOLL = 12;
        public static int ELEMENT_ENEMY = 20;
        public static int BALCONY = 21;
        public static int WEAPON = 23;
        public static int COIN = 22;
        public static int ENEMY = 10;
        public static int BULLET_PLAYER = 18;
        public static int ONLY_PLAYER = 7;
        public static int INVISIBLE_GROUND = 21;
        public static int PLAYER_EXCLUDER = 8;
