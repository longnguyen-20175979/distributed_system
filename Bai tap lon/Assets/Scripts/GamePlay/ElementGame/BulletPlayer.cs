    ...
    private void OnTriggerEnter2D(Collider2D collision) {
        if (collision.gameObject.GetComponent<ElementEnemy>() != null) {
            ...
            if (explore != null) {
                ...
                gameObject.SetActive(false);
            move = false;
        } else if ((collision.gameObject.layer != 0 && collision.gameObject.layer != 17 && collision.gameObject.layer != 24 && collision.gameObject.layer != 7) || (collision.tag != Constants.TAG.ENEMY && collision.gameObject.layer != 17 && collision.gameObject.layer != 24 && collision.gameObject.layer != 7)) {
            if (explore != null) {
                Explosion();
            } else
                gameObject.SetActive(false);
        ...
        {
            transform.GetChild(0).GetComponent<SpriteRenderer>().sortingLayerName = "Forgotten";
        }
    }
