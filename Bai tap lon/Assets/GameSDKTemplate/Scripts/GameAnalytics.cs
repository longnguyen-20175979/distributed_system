...
public class GameAnalytics {
...
#if UNITY_ANDROID
    public const string ADJUST_ET_IN_APP_PURCHASE = "ns4bw7";
    public const string ADJUST_ET_LEVEL_START = "7xo041";
    public const string ADJUST_ET_LEVEL_PASSED = "5xr24x";
    public const string ADJUST_ET_LEVEL_FAILED = "6j6is3";
    
#else
    public const string ADJUST_ET_IN_APP_PURCHASE = "69gb8o";
    public const string ADJUST_ET_LEVEL_START = "h1hsr1";
    public const string ADJUST_ET_LEVEL_PASSED = "ffvwad";
    public const string ADJUST_ET_LEVEL_FAILED = "ax7hky";
#endif
    #region OldCode
    ...
    public static void LogLevelStart(int level, string from, string character, bool isRestart) {
        ...
        firebaseParams[2] = new Parameter("character", character);
        ...
        {
            GameData.LevelMax = GameData.LevelUnlock;
        }
        else GameData.LevelMax = GameData.LevelUnlock - 1;
        //GameData.LevelStartCount++;
        AdjustEvent e = new AdjustEvent(ADJUST_ET_LEVEL_START);
        Adjust.trackEvent(e);
    }
    public static void LogLevelEnd(int level, bool pass, float timeSpent, float duration, string character, string from, int bulletUsed, int heartLosed) {
        Parameter[] firebaseParams = new Parameter[8];
        firebaseParams[0] = new Parameter("level", level);
        ...
        firebaseParams[4] = new Parameter("character", character);
        firebaseParams[5] = new Parameter("from", from);
        firebaseParams[6] = new Parameter("using_total_bullet", bulletUsed);
        firebaseParams[7] = new Parameter("losing_total_heart", heartLosed);
    ...
    public static void LogRevive(int level, string method, string character) {
    ...
    public static void LogPlayerDie(int level, int xPos, int yPos, string character) {
        Parameter[] firebaseParams = new Parameter[4];
        firebaseParams[0] = new Parameter("level", level);
        firebaseParams[1] = new Parameter("x_position", xPos);
        firebaseParams[2] = new Parameter("y_position", yPos);
        firebaseParams[3] = new Parameter("character", character);
    ...
    public static void LogWatchRewardAdsDone(string scenarios, bool hasVideo, string result)
    {
        ...
        firebaseParams[0] = new Parameter("scenarios", scenarios);
        firebaseParams[1] = new Parameter("has_video", hasVideo.ToString());
        firebaseParams[2] = new Parameter("result", result.ToString());
