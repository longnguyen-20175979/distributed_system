...
public class SDKPlayPrefs {
    ...
    public static void UpdatePictureStartedAt(int pictureId) {
        SetDateTime(StringConstants.PREF_PICTURE_STARTED_AT_PREFIX + pictureId, UnbiasedTime.Instance.Now());
    }
    ...
    public static void UpdateLocalPictureCreatedAt(int pictureId) {
        SetDateTime(StringConstants.PREF_LOCAL_PICTURE_CREATED_AT_PREFIX + pictureId, UnbiasedTime.Instance.Now());
    }
