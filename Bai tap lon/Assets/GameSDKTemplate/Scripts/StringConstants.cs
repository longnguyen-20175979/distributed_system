...
public class StringConstants {
    ...
    public const string GEM_RECEIVED = "gem_received";
    public const string BULLET_RECEIVED = "bullet_received";
    ...
    public const string HALLOWEEN_2022_EVENT_CODE = "halloween2022";
